...
const CartBtn = styled.div`
  color: ${(props) => (props.condition ? "rgb(244,51,151)" : "black")};
  display: flex;
  flex-direction: column;
  align-items: center;
      ...
      <Container>
        <MainNav>
          <Link to="/">
            <LeftNavbar>
              ...
              <svg
                ...
                width="156"
                height="36"
                className="Icon-sc-1iwi4w1-0 cZPTbN"
              >
                <path
          ...
          <RightNav>
            ...
            <VerticalLine />
            <ProfileContainer onClick={ClickHandle}>
              <CgProfile style={{ fontSize: "28px" }}></CgProfile>Profile
            </ProfileContainer>
            <CartBtn
              condition={condition === true}
              onClick={() => navigate("/cart")}
            ><span style={{color:"rgb(255,51,151)",fontWeight:"1000"}}>{Length-1}</span>
              <AiOutlineShoppingCart style={{ fontSize: "28px" }} ></AiOutlineShoppingCart>
              Cart
            </CartBtn>
          </RightNav>
        </MainNav>
